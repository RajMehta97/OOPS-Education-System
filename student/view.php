...
<head>
    ...
    <title>MONTE CARLO VIEW BOOKING</title>
            ...
            <div class="page-head">
				...
				if(@$_GET['view']==1){
							...
							if($option=="bookid"){
							 ...
							 echo'<form role="form" method="POST" action="view.php?bookidgiven=1">';
							...
							if($option=="dates"){
							 echo'<div class="form-group">';
							 echo'<form role="form" method="POST" action="view.php?datesgiven=1">';
							 ...
							 echo'<div class="form-group">';
							 echo'<form role="form" method="POST" action="view.php?custnamegiven=1">';
                            ...
                            <table class="table table-striped">
								...
								<?php
									if(isset($_GET['bookidgiven'])){
										...
										$query="Select * FROM `booking` WHERE booking_id='$bookID_booking';";
									...
									echo "</tr>";
										...
										$query="Select * FROM `booking` WHERE checkin='$checkin' AND checkout='$checkout';";
										$query_res=mysqli_query($conn,$query);
									while($row=mysqli_fetch_array($query_res)){
									echo "<tr>";
									echo "<td>".$row['booking_id']."</td>";
									...
									echo "</tr>";
										...
										$query="Select * FROM `booking` WHERE last_name='$customer_name';";
										$query_res=mysqli_query($conn,$query);
									while($row=mysqli_fetch_array($query_res)){
									echo "<tr>";
									echo "<td>".$row['booking_id']."</td>";
