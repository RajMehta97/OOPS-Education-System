...
<head>
    ...
    <title>ELEARNING SYSTEM : VERIFY TOPIC</title>
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['updated']==1){
					$success='Topic Verified Succesfully';
				}
				else{
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="verify_topic.php?updated=1">
          ...
          $topicid=@$_POST['topicid'];
					$sql="UPDATE `topics` SET validity='1' where  name='$topic' and subject='$subject' and topicid='$topicid';";
					...
					//echo "<span class='sub-title'>Bike Data Added Succesfully</span>";
						...
						echo"<strong>"."Please enter an existing Topic ID"."<br>"."And make sure all fields are filled"."</strong>";
					}
				...
				<div class="col-lg-6">
                  ...
                  <th>CLICK HERE</th>
								...
								<tbody>
								<?php
									$query="Select * FROM `topics` where validity='0';";
									$query_res=mysqli_query($conn,$query);
									while($row=mysqli_fetch_array($query_res)){
                    $way="../teacher/".$row['link'];
									echo "<tr>";
