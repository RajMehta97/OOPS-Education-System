...
<head>
    ...
    <title>Elearning System: ADD PROFESSOR</title>
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['added']==1){
					$success='Professor Added Succesfully';
				}
				else{
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="add_prof.php?added=1">
				...
				<?php
						$required = array('username', 'password','name');
						$error = false;
					...
					//if((isset($_POST['username']) && isset($_POST['password']) && isset($_POST['name']) && isset($_POST['type'])))
            //echo 'HELLOOO WORLDDD!!!!!!!!!!!!!!!!!!!!!!!!!';
          $username=$_POST['username'];
					$password=$_POST['password'];
          $name=$_POST['name'];
					$sql="INSERT INTO `members`(`username`,`password`,`name`,`type`) VALUES('$username','$password','$name','professor');";
					$res=mysqli_query($conn,$sql);
					/*if($res==1){
					echo "<span class='sub-title'>Bike Data Added Succesfully</span>";
					$success='Bike Data Added Succesfully';
