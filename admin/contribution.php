        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['view']==1){
							 ...
							 echo'<form role="form" method="POST" action="contribution.php?idgiven=1">';
                             echo'<label for="Username">Professor UserName</label>';
				...
				?>
                <span class="sub-title"><?php echo 'Welcome to Elearning System';?></span>
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="contribution.php?view=1">
					...
					<section class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
								...
								<tbody>
								<?php
									if(isset($_GET['idgiven'])){
										$uname=$_POST['username'];
										$query="Select * FROM `topics` WHERE username='$uname';";
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped">
        								...
        								<?php
        									if(isset($_GET['idgiven'])){
        										$uname=$_POST['username'];
        										$query="Select * FROM `quiz` WHERE username='$uname';";
        										$query_res=mysqli_query($conn,$query);
        									while($row=mysqli_fetch_array($query_res)){
        									echo "<tr>";
