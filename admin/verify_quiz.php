...
<head>
    ...
    <title>ELEARNING SYSTEM : VERIFY QUIZ</title>
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['updated']==1){
					$success='Quiz Verified Succesfully';
				}
				else{
				$success='Welcome to Elearning Sytstem';
				}?>
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="verify_quiz.php?updated=1">
                                <div class="form-group">
                                    <label for="quizid">QUIZ ID</label>
                                    <input type="text"  name="quizid" class="form-control" placeholder="QUIZ ID">
                                </div>
                                <div class="form-group">
          ...
          $quizid=@$_POST['quizid'];
					$sql="UPDATE `quiz` SET validity='1' where  topic='$topic' and subject='$subject' and quizid='$quizid';";
					...
					//echo "<span class='sub-title'>Bike Data Added Succesfully</span>";
						...
						echo"<strong>"."Please enter an existing Quiz ID"."<br>"."And make sure all fields are filled"."</strong>";
					}
				...
				<div class="col-lg-6">
                  ...
                  <th>USERNAME</th>
								...
								<tbody>
								<?php
									$query="Select * FROM `quiz` where validity='0';";
