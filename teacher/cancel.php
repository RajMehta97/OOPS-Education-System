...
<head>
    ...
    <title>ELEARNING CANCEL BOOKING</title>
          ...
          $entry = new topic;
              ...
              $user=$_COOKIE["user"];
						 ...
						 $entry->setName($_POST['name']);
							$sql = "SELECT link, username FROM topics WHERE topicid='$id' AND name='$entry->name';";
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="cancel.php?delete=1">
