...
<head>
    ...
    <title>Elearning Add topic </title>
          ...
          // if everything is ok, try to upload file
            ...
            $entry->setUploader($_COOKIE["user"]);
                //  echo $uploader."is user";
                      ...
                      $sql="INSERT INTO topics(name,link,subject,validity,username) VALUES('$entry->name','$file','$entry->subject','$entry->validity','$entry->uploader');";
                      $result=mysqli_query($conn,$sql);
                      if($result){
                          $success="File Sucessfully uploaded";

                      } else $success ='could not insert file';
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="modify.php?modify=1" ENCTYPE='multipart/form-data'>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="radio" name="subject"  value="4"> Physics</div>
                                <div class="form-group">
