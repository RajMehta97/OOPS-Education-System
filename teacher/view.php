            ...
            <div class="page-head">
				...
				if(@$_GET['view']==1){
							...
							if($option=="topicid"){
							 ...
							 echo'<form role="form" method="POST" action="view.php?topicidgiven=1">';
                             echo'<label for="Topic ID">Topic ID</label>';
                             echo'<input type="text"  name="topicID_topic" class="form-control" placeholder="topic ID">';
							...
							if($option=="subject"){
							 echo'<div class="form-group">';
							 echo'<form role="form" method="POST" action="view.php?subjectgiven=1">';
                             echo'<label for="subject">subject</label>';
                             echo'<input type="text"  name="subject" class="form-control" placeholder="code">';
							 echo'<button type="submit" class="btn btn-info">Submit</button>';
							 echo'</form>';
                             echo'</div>';
							}
							 ...
							 echo'<div class="form-group">';
							 echo'<form role="form" method="POST" action="view.php?namegiven=1">';
                             echo'<label for="Name">Name</label>';
                             echo'<input type="text"  name="name_name" class="form-control" placeholder="Name">';
							 echo'<button type="submit" class="btn btn-info">Submit</button>';
							 echo'</form>';
                             echo'</div>';
							}
				...
				?>
                <span class="sub-title"><?php echo 'Welcome to Elearning Portal';?></span>
                </div>
            <!-- page head end-->
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="view.php?view=1">
				...
				<div class="col-lg-6">
                  ...
                  <th>link</th>
								...
								<tbody>
								<?php
									if(isset($_GET['topicidgiven'])){
										$topicID_topic=$_POST['topicID_topic'];
										$query="Select * FROM `topics` WHERE topicid='$topicID_topic';";
                  ...
                  echo "<td><a href=".$row['link']." >click</td>";
									echo "</tr>";
                  //      $file = $row['file'];
									...
									else if(isset($_GET['subjectgiven'])){
										$subject=$_POST['subject'];

										$query="Select * FROM `topics` WHERE subject='$subject';";
										$query_res=mysqli_query($conn,$query);
									while($row=mysqli_fetch_array($query_res)){
									echo "<tr>";
                  echo "<td>".$row['topicid']."</td>";
